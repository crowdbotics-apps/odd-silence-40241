"""
Django settings for odd_silence_40241 project.
...
ROOT_URLCONF = 'odd_silence_40241.urls'
...
WSGI_APPLICATION = 'odd_silence_40241.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_silence_40241 API",
    "DESCRIPTION": "API documentation for odd_silence_40241 App",
    "VERSION": "v1",
}
